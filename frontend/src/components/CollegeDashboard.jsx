...
const CollegeDashboard = () => {
  ...
  const fetchStudents = async () => {
    try {
      ...
      const response = await axios.get('https://id-card-project-backend.onrender.com/api/college/students');
  ...
  const generateLink = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://id-card-project-backend.onrender.com/api/college/generate-link');
  ...
  const downloadExcel = async () => {
    try {
      ...
      const response = await axios.get('https://id-card-project-backend.onrender.com/api/college/download-excel', {
        responseType: 'blob',
      });
  ...
  const downloadImages = async () => {
    try {
      ...
      const response = await axios.get('https://id-card-project-backend.onrender.com/api/college/download-images', {
        responseType: 'blob',
      });
  ...
  const generateIDCards = async () => {
    ...
    try {
      const response = await axios.get('https://id-card-project-backend.onrender.com/api/college/generate-id-cards', {
