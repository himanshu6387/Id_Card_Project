...
const StudentForm = () => {
  ...
  const fetchLinkDetails = async () => {
    try {
      const response = await axios.get(`https://id-card-project-4.onrender.com/api/student/link/${linkId}`);
  ...
  const handleRemoveBackground = async () => {
    setRemovingBg(true);
    try {
      const response = await axios.post('https://id-card-project-4.onrender.com/api/student/remove-background', {
        image: originalImage
      });
